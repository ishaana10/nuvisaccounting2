...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estàs rebent aquest correu electrònic perquè estàs convidat a unir-te a l\'NuvisFinance.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalitza el teu NuvisFinance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Tenen accés complet al vostre NuvisFinance, inclosos clients, factures, informes, configuracions i aplicacions.',
        ],
        'manager' => [
            'name'          => 'Gerent',
            'description'   => 'Tenen accés complet al teu NuvisFinance, però no poden gestionar usuaris i aplicacions.',
        ],
        'customer' => [
            'name'          => 'Client',
