...
return [
    ...
    'invitation' => [
        'message_1'         => 'Tento e-mail ste dostali, pretože ste pozvaní do NuvisFinanceu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prispôsobte si svoj NuvisFinance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrátor',
            'description'   => 'Získajú úplný prístup k vášmu NuvisFinanceu vrátane zákazníkov, faktúr, prehľadov, nastavení a aplikácií.',
        ],
        'manager' => [
            'name'          => 'Manažér',
            'description'   => 'Získajú úplný prístup k vášmu NuvisFinanceu, ale nemôžu spravovať používateľov a aplikácie.',
        ],
        'customer' => [
            'name'          => 'Zákazník',
