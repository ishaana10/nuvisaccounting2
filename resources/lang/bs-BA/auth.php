...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primili ste ovaj email jer ste pozvani da se pridružite NuvisFinanceu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prilagodite svoj NuvisFinance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Oni dobijaju potpuni pristup vašem NuvisFinance-u uključujući klijente, fakture, izvještaje, postavke i aplikacije.',
        ],
        'manager' => [
            'name'          => 'Upravljaj',
            'description'   => 'Oni imaju potpuni pristup vašem NuvisFinanceu, ali ne mogu upravljati korisnicima i aplikacijama.',
        ],
        'customer' => [
            'name'          => 'Kupci',
