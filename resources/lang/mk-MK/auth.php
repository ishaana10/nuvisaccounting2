...
return [
    ...
    'invitation' => [
        'message_1'         => 'Ја добивате оваа е-пошта затоа што сте поканети да се придружите на NuvisFinance.',
    ...
    'information' => [
        ...
        'customize'         => 'Прилагодете го вашиот NuvisFinance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Админ',
            'description'   => 'Тие добиваат целосен пристап до вашиот NuvisFinance вклучувајќи клиенти, фактури, извештаи, поставки и апликации.',
        ],
        'manager' => [
            'name'          => 'Менаџер',
            'description'   => 'Тие добиваат целосен пристап до вашиот NuvisFinance, но не можат да управуваат со корисници и апликации.',
        ],
        'customer' => [
            'name'          => 'Клиент',
