...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the NuvisFinance.',
    ...
    'information' => [
        ...
        'customize'         => 'Customize your NuvisFinance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your NuvisFinance including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your NuvisFinance, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
