...
return [
    ...
    'messages' => [
        ...
        'create_document_transaction_error' => 'This endpoint cannot be added to a document. Use {{nuvisfinance_url}}/documents/{{nuvisfinance_document_id}}/transactions',
        'update_document_transaction_error' => 'This endpoint cannot be updated to a document. Use {{nuvisfinance_url}}/documents/{{nuvisfinance_document_id}}/transactions/{nuvisfinance_transaction_id}',
        'delete_document_transaction_error' => 'This endpoint cannot be deleted to a document. Use {{nuvisfinance_url}}/documents/{{nuvisfinance_document_id}}/transactions/{nuvisfinance_transaction_id}',
    ],
