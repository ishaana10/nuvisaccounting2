...
return [
    ...
    'invitation' => [
        'message_1'         => 'Obdrželi jste tento e-mail, protože jste pozváni do NuvisFinanceu.',
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Správce',
            'description'   => 'Mají plný přístup k Vašemu NuvisFinanceu, ale nemohou spravovat uživatele a aplikace.',
        ],
        'customer' => [
            'name'          => 'Zákazník',
